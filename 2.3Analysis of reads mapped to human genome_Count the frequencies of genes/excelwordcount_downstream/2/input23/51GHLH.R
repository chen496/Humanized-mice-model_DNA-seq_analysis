...
Data<- read.xlsx("E:/Data/excelwordcount/2/input23/Total/51GHLH.xlsx",sheet=1)
...
# 首先读取output24里面的文件
path <- 'E:/Data/excelwordcount/2/input23/51GHLH/'
dir.name <- dir(path)
doc.name <- list()
fre <- numeric()
...
write.csv(a,file="E:/Data/excelwordcount/2/output23/51GHLH.csv")
