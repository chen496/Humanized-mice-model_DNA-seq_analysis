...
Data<- read.xlsx("E:/Data/excelwordcount/2/input23/Total/51GHLM.xlsx",sheet=1)
...
# 首先读取output24里面的文件
path <- 'E:/Data/excelwordcount/2/input23/51GHLM/'
dir.name <- dir(path)
doc.name <- list()
fre <- numeric()
...
a<-t(a)
write.csv(a,file="E:/Data/excelwordcount/2/output23/51GHLM.csv")
