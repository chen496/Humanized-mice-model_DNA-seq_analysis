...
Data<- read.xlsx("E:/Data/excelwordcount/2/input23/Total/51GHLP.xlsx",sheet=1)
...
# 首先读取output24里面的文件
path <- 'E:/Data/excelwordcount/2/input23/51GHLP/'
dir.name <- dir(path)
doc.name <- list()
fre <- numeric()
...
a<-t(a)
write.csv(a,file="E:/Data/excelwordcount/2/output23/51GHLP.csv")
